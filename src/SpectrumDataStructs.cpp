...
bool MeasurementInfo::load_from_cnf( std::istream &input )
{
  ...
  try
  {
    ...
    readBinaryData( input, w34 );
    readBinaryData( input, w36 );
    ...
    readBinaryData( input, I );
    readBinaryData( input, J );
    ...
    readBinaryData( input, num_channels );
...
bool MeasurementInfo::load_from_aram( std::istream &input )
{
  ...
  try
  {
    ...
    passMessage( "The ARAM file format has a time history in it that is not decoded", "", 1 );
