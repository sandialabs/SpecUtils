# SpecUtils Java Bindings — Linux x86_64
...
Built on manylinux_2_28 (glibc 2.28+), compatible with RHEL 8+, Ubuntu 20.04+, Debian 10+, and similar.
...
| `libSpecUtilsJni.so` | Native JNI shared library |
...
2. Place `libSpecUtilsJni.so` somewhere on your library path.
3. In your Java code:
